...
import webservice.jaxrs.provider.serviceProvider;
...
public class ApplicationConfig extends Application {
    ...
    public Set<Class<?>> getClasses() {
        ...
        resources.add(webservice.jaxrs.provider.serviceProvider.class);
        resources.add(webservice.jaxrs.resource.DocumentResources.class);
        resources.add(webservice.jaxrs.resource.QuantityResources.class);
