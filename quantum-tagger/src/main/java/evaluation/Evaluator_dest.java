...
public class Evaluator_dest {
	...
	static Experiment[] experiments = {
			new Experiment(SETTINGS_ID.NO_CAND_CAND, EXPERIMENT_ID.full_dest,
					"sarwagy_downey_exp_NO_CAND_CAND_full_dest"),
			new Experiment(SETTINGS_ID.NO_TABLE_STRUCTURE, EXPERIMENT_ID.full_dest,
					"sarwagy_downey_exp_NO_TABLE_STRUCTURE_full_dest"),
			new Experiment(SETTINGS_ID.NO_SAME_SURFACE, EXPERIMENT_ID.full_dest,
					"sarwagy_downey_exp_NO_SAME_SURFACE_full_dest"),
//			new Experiment(SETTINGS_ID.NO_CAND_CAND, EXPERIMENT_ID.part_dest_cohen_p,
//					"sarwagy_downey_exp_NO_CAND_CAND_part_dest"),
//			new Experiment(SETTINGS_ID.NO_TABLE_STRUCTURE, EXPERIMENT_ID.part_dest_cohen_p,
//					"sarwagy_downey_exp_NO_TABLE_STRUCTURE_part_dest"),
//			new Experiment(SETTINGS_ID.NO_SAME_SURFACE, EXPERIMENT_ID.part_dest_cohen_p,
//					"sarwagy_downey_exp_NO_SAME_SURFACE_part_dest"),
			new Experiment(SETTINGS_ID.DEFAULT, EXPERIMENT_ID.full_dest, "sarwagy_downey_exp_full_dest"),
//			new Experiment(SETTINGS_ID.DEFAULT, EXPERIMENT_ID.part_dest_cohen_p,
//					"sarwagy_downey_norm_exp_part_dest_cohen_plus") 
			};
...
//		}
	...
	public static void main_old(String arg[]) throws IOException {
		...
		String web_tables_fixed = "/GW/D5data/yibrahim/misc/data/SunitaSarawagi/TablesannotationData/fixedWebTables.txt";
		String web_tables = "/GW/D5data/yibrahim/misc/data/SunitaSarawagi/TablesannotationData/webtables_flat.txt";
		String wiki_links = "/GW/D5data/yibrahim/misc/data/SunitaSarawagi/TablesannotationData/wikilinks_flat.txt";
		String wiki_tables = "/GW/D5data/yibrahim/misc/data/SunitaSarawagi/TablesannotationData/wikitables_flat.txt";
		Sarwagi sunita;
		// webtables
		try {
