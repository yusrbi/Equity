...
public class test {
	...
	static Experiment[] experiments = {
			new Experiment(SETTINGS_ID.NO_TABLE_STRUCTURE, EXPERIMENT_ID.part_src, "1108_test_test"), 
			new Experiment(SETTINGS_ID.NO_TABLE_STRUCTURE, EXPERIMENT_ID.full_src, "1108_test_test"), 
		//	new Experiment(SETTINGS_ID.DEFAULT, EXPERIMENT_ID.part_src, "0708_2_runtime_part_src"),
			};
	//static String[] experiments = {"Test-Directed-RWR"};
