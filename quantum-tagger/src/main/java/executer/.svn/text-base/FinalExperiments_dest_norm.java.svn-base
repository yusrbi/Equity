...
public class FinalExperiments_dest_norm {
	...
	static Experiment[] experiments = {
			new Experiment(SETTINGS_ID.NO_CAND_CAND, EXPERIMENT_ID.part_dest_cohen_p, "0508_norm_exp_NO_CAND_CAND_part_dest_cohen_plus"),
			new Experiment(SETTINGS_ID.NO_TABLE_STRUCTURE, EXPERIMENT_ID.part_dest_cohen_p, "0508_norm_exp_NO_TABLE_STRUCTURE_part_dest_cohen_plus"),
			new Experiment(SETTINGS_ID.NO_SAME_SURFACE, EXPERIMENT_ID.part_dest_cohen_p, "0508_norm_exp_NO_SAME_SURFACE_part_dest_cohen_plus"),			
			new Experiment(SETTINGS_ID.DEFAULT, EXPERIMENT_ID.part_dest_cohen_p, "0508_norm_exp_part_dest_cohen_plus"),
		};
	...
	public static void main(String arg[]) throws IOException {
		...
		File dir = null;
		///****************Cohen Normalization****************//
		GraphBuilder.setCohenNormalization(true);
